...
def submit_violation():
    ...
    try:
        ...
        violation_date = datetime.strptime(request.form.get('violation_date'), '%Y-%m-%d').date()
        violation_time = datetime.strptime(request.form.get('violation_time'), '%H:%M').time()
...
def admin_edit_violation(violation_id):
    ...
    if request.method == 'POST':
        try:
            ...
            violation.violation_date = datetime.strptime(
                request.form.get('violation_date'), '%Y-%m-%d'
            ).date()
            violation.violation_time = datetime.strptime(
                request.form.get('violation_time'), '%H:%M'
            ).time()
